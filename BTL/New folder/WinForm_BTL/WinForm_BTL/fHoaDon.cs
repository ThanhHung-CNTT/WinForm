...
namespace WinForm_BTL
{
    public partial class fHoaDon : Form
    {
        ...
        private void fHoaDon_Load(object sender, EventArgs e)
        {
            ...
            HoaDonDAO.Instance.ThemDanhSachMaKhachHangVaoComboBox(cbMaKhachHang);
        }
        void LoadHoaDon()
        {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            {
                using (var cmd = new SqlCommand("UPDATE KHACHHANG SET TichLuy= @TichLuy WHERE MaKH = @MaKH; "))
                {
                    cmd.Connection = connect;
                    int diem;
                    double tongtien = Convert.ToDouble(txtTongTien.Text);
                    cmd.Parameters.AddWithValue("@MaKH", Convert.ToInt32(cbMaKhachHang.Text));
                    diem = Convert.ToInt32(tongtien % 10000);
                    cmd.Parameters.AddWithValue("@TichLuy", Convert.ToInt32(txtTongTien.Text) + diem);
                    connect.Open();
